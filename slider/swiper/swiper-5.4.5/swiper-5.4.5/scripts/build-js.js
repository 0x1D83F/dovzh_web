  ...
  rollup.rollup({
    ...
    const minified = Terser.minify(result.code, {
      sourceMap: {
        ...
        filename: env === 'development' ? undefined : 'swiper_main.esm.browser.bundle.min.js',
    ...
    fs.writeFileSync('./package/js/swiper_main.esm.browser.bundle.min.js', minified.code);
    fs.writeFileSync('./package/js/swiper_main.esm.browser.bundle.min.js.map', minified.map);
    if (cb) cb();
  }).catch((err) => {
    if (cb) cb();
    console.error(err.toString());
...
function umd(components, cb) {
  ...
  rollup.rollup({
    ...
    const minified = Terser.minify(result.code, {
      sourceMap: {
        content: env === 'development' ? result.map : undefined,
        filename: env === 'development' ? undefined : 'swiper_main.min.js',
    ...
    fs.writeFileSync('./package/js/swiper_main.min.js', minified.code);
    fs.writeFileSync('./package/js/swiper_main.min.js.map', minified.map);
