...
gulp.task('playground', (cb) => {
  ...
  if (env === 'development') {
    content = content
      .replace('../package/css/swiper_main.min.scss', '../build/css/swiper_main.scss')
      .replace('../package/js/swiper_main.min.js', '../build/js/swiper_settings.js');
  } else {
    content = content
      .replace('../build/css/swiper_main.scss', '../package/css/swiper_main.min.scss')
      .replace('../build/js/swiper_settings.js', '../package/js/swiper_main.min.js');
  }
